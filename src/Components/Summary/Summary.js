    ...
    async function handleSummary(){
        try {
            if(content === ''){
                ...
                setLoading(true);
                // const res = await axios.post('https://aifusion-project-2.onrender.com/aiSummrize',{content})
                // console.log("content is >>" , content);
                const res = await axios.post('https://ai-tool-server.onrender.com/ai/summary',{content})
                // console.log(res.data);
                setValue(res.data.summary);
                setLoading(false); 
            }
            // console.log(res);
    ...
    <div className='summ_body'>
        ...
        <div className='summ_main'>
            <div className='summ_right'>
                ...
                <textarea className='summ_para' onChange={(e)=>setcontent(e.target.value)}/>
            </div>
